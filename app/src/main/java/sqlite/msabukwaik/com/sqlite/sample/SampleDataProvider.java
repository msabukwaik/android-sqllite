package sqlite.msabukwaik.com.sqlite.sample;
...
/**
 * Created by msabukwaik on 6/13/17.
 */

public class SampleDataProvider {

    public static List<DataItem> dataItemList;
    public static Map<String, DataItem> dateItemMap;

    static {
        dataItemList = new ArrayList<>();
        dateItemMap = new HashMap<>();
    ...
    private static void addItem( DataItem item ){
        ...
        dateItemMap.put(item.getItemId(), item);
    }
}
